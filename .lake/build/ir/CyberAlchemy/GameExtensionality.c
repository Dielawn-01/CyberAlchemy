...
// Module: CyberAlchemy.GameExtensionality
// Imports: public import Init public import CyberAlchemy.ProtorealOperator public import CyberAlchemy.ProtorealManifold public import CyberAlchemy.LieAlgebra
#include <lean/lean.h>
...
extern "C" {
#endif
LEAN_EXPORT lean_object* lp_CyberAlchemy_sprite__flip(lean_object*);
LEAN_EXPORT lean_object* lp_CyberAlchemy_sprite__flip(lean_object* x_1) {
_start:
{
uint8_t x_2; 
...
LEAN_EXPORT lean_object* initialize_CyberAlchemy_CyberAlchemy_GameExtensionality(uint8_t builtin) {
lean_object * res;
