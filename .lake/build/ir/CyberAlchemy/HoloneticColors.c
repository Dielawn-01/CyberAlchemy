...
// Module: CyberAlchemy.HoloneticColors
...
extern "C" {
#endif
LEAN_EXPORT lean_object* lp_CyberAlchemy_C;
static lean_object* _init_lp_CyberAlchemy_C(void) {
_start:
{
lean_object* x_1; 
...
LEAN_EXPORT lean_object* initialize_CyberAlchemy_CyberAlchemy_HoloneticColors(uint8_t builtin) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
lp_CyberAlchemy_C = _init_lp_CyberAlchemy_C();
lean_mark_persistent(lp_CyberAlchemy_C);
