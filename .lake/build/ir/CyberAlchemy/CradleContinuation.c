...
// Module: CyberAlchemy.CradleContinuation
// Imports: public import Init public import CyberAlchemy.ProtorealManifold public import CyberAlchemy.TopologicalImaginary public import CyberAlchemy.EulersCradle
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* lp_CyberAlchemy_CradleContinuation_cradle__continuation(lean_object*);
LEAN_EXPORT lean_object* lp_CyberAlchemy_CradleContinuation_cradle__continuation(lean_object* x_1) {
_start:
{
uint8_t x_2; 
...
lean_inc(x_9);
lean_dec(x_1);
x_12 = lp_mathlib_Real_definition_00___x40_Mathlib_Data_Real_Basic_1850581184____hygCtx___hyg_8_;
...
LEAN_EXPORT lean_object* initialize_CyberAlchemy_CyberAlchemy_CradleContinuation(uint8_t builtin) {
lean_object * res;
