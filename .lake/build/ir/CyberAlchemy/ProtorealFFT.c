...
extern "C" {
#endif
lean_object* lp_CyberAlchemy_TopologicalImaginary_bridge__norm(lean_object*);
LEAN_EXPORT lean_object* lp_CyberAlchemy_ProtorealFFT_spectral__energy(lean_object*);
LEAN_EXPORT lean_object* lp_CyberAlchemy_ProtorealFFT_spectral__energy(lean_object* x_1) {
_start:
{
lean_object* x_2; 
x_2 = lp_CyberAlchemy_TopologicalImaginary_bridge__norm(x_1);
return x_2;
}
}
...
LEAN_EXPORT lean_object* initialize_CyberAlchemy_CyberAlchemy_ProtorealFFT(uint8_t builtin) {
lean_object * res;
