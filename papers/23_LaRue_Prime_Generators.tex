...
\subsection[The Metareal Tensor Projection and]{The Metareal Tensor Projection and Biological Dimensional Shear}
...
This asymptotic superiority—demonstrating that the Hybrid GAN algorithm is strictly faster than a sequential Miller-Rabin search for all numbers $X > e^2$—was formally verified in Lean 4 (\texttt{CyberAlchemy/InfoPhysAxioms/PrimeGANComplexity.lean}):
\begin{verbatim}
