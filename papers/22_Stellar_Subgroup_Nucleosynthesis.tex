...
where $\omega = 94$ is the cube root of unity in $\mathbb{F}_{229}$. The
confinement identity $1 + \omega + \omega^2 \equiv 0 \pmod{229}$ holds:
\begin{equation}
...
\begin{enumerate}
  ...
  \item \textbf{Confinement ignition}: Further captures produce Pu (94, $C_3$) and
    Am (95, $C_6$). These maintain the confinement condition $1 + \omega + \omega^2 = 0$.
...
\begin{prediction}[Gaia Astrometric Excess]
...
\begin{prediction}[Proper Motion Anomaly]
...
\begin{prediction}[Spectral Stability]
