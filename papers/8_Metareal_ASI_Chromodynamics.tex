...
\bibitem{larue_lc}
La Rue, D. (2026).
\textit{Logical Creativity: The Zeta Core}.
\bibitem{PDG2025}
...
Lockwood, J. (2026).
\textit{Chronometric Constants and Frozen Spectral Relations}.
Private communication (Chrono 3 \& Chrono 4).

\bibitem{larue_chromatic}
La Rue, D. and Lockwood, J. (2026).
\textit{The SU(3) Center Triangle: Golden Split Primes, Standing Waves in Digit Space, and the Dark-Bright Palindrome Resonance}.
Preprint.

\bibitem{lockwood_zpe2025}
Lockwood, J., Cyrek, C., Burkeen, D., and Hansley, D. (2025).
...
\bibitem{connes}
Connes, A.~T. \& Connes, A. (1991).
\textit{PiHKAL: A Chemical Love Story}.
Transform Press.
...
\bibitem{luminet2003}
Luminet, J.-P., Weeks, J.R., Riazuelo, A., Lehoucq, R., Uzan, J.-P. (2003).
...
\textit{Phys.\ Rev.\ D} 21, 2308.

\bibitem{jaffe2000}
Jaffe, A., and Witten, E. (2000).
``Quantum Yang-Mills theory.''
\textit{Clay Mathematics Institute}, Millennium Prize Problem Description.

\bibitem{wilson1974}
Wilson, K.G. (1974).
``Confinement of quarks.''
\textit{Phys.\ Rev.\ D} 10, 2445.

\bibitem{goldwasser1989}
Goldwasser, S., Micali, S., and Rackoff, C. (1989).
``The Knowledge Complexity of Interactive Proof Systems.''
\textit{SIAM Journal on Computing}, 18(1), 186--208.
...
\bibitem{charles-lauter-goren2009}
Charles, D.X., Lauter, K.E., and Goren, E.Z. (2009).
``Cryptographic Hash Functions from Expander Graphs.''
\textit{Journal of Cryptology}, 22(1), 93--113.
...
\bibitem{renault1996}
Renault, M. (1996).
\textit{The Fibonacci Sequence Under Various Moduli}.
