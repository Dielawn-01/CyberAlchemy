...
\begin{itemize}[noitemsep]
  \item \textbf{Theorem / Verified Computation:} Finite-field splitting at $p \in \{139, 181, 229\}$, cyclic subgroup decompositions, golden tetrahedron invariants (Vieta identities), conjugate orbit closure ($\mathrm{ord}(\bar\varphi) = 57$ at $p=229$), and the FBBT halting bound via Baby-step Giant-step discrete logarithm ($O(\log p)$).
