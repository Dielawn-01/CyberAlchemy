...
\bibitem{LaRue_PP}
D. La Rue,
\emph{Principia Psychedelia: Logical Creativity, Observational Mechanics, and Archetypal Synthetic Intelligence},
Las Vegas, NV, 2025--2026.

\bibitem{McDonough95}
W.F. McDonough, S.-S. Sun,
``The composition of the Earth,''
\emph{Chem. Geol.} \textbf{120}, 223 (1995).

\bibitem{Artin_Algebra}
M. Artin,
\emph{Algebra}, 2nd ed., Pearson, 2010.

\bibitem{Brostigen69}
G. Brostigen, A. Kjekshus,
``Redetermined crystal structure of FeS$_2$ (pyrite),''
\emph{Acta Chem. Scand.} \textbf{23}, 2186 (1969).
...
\emph{Science} \textbf{324}, 1306 (2009).

\bibitem{Birch52}
F. Birch,
``Elasticity and constitution of the Earth's interior,''
\emph{J. Geophys. Res.} \textbf{57}, 227 (1952).
...
\emph{Bull. Chem. Soc. Japan} \textbf{44}, 2332 (1971).

\bibitem{Hosoya76}
H. Hosoya,
``Fibonacci triangle,''
\emph{Fibonacci Quart.} \textbf{14}, 173 (1976).
