...
Verified: \texttt{lockwood\_aqft.py}, theorems \texttt{argon\_twelve\_tone} and \texttt{argon\_parity\_inversion}.
\end{result}
...
\input{../local_bibs/local_bib_11_Triple_Helix_Mechanics}
\end{document}
