...
\begin{tikzpicture}[remember picture, overlay]
  ...
  \node[anchor=center] at ([yshift=-3.5cm]current page.north)
    {\fontsize{14}{18}\selectfont\sffamily\color{golden}\addfontfeatures{LetterSpace=12}%
     PRINCIPIA};
  ...
  \node[anchor=center] at ([yshift=-7.2cm]current page.north)
    {\fontsize{14}{18}\selectfont\sffamily\color{golden}\addfontfeatures{LetterSpace=8}%
     VOLUME II};
