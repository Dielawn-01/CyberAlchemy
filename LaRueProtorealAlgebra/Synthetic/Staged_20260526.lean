...
theorem automatic_differentiation_spawns_noise (u : ProtorealManifold) : (automatic_differentiation u).e > u.e := by
...
theorem synthetic_integration_then_automatic_differentiation_noise (u : ProtorealManifold) : (automatic_differentiation (synthetic_integration u)).e = 1 := by
  unfold synthetic_integration
  unfold automatic_differentiation
  simp
...
theorem synthetic_integration_idempotent_noise (u : ProtorealManifold) : (synthetic_integration (synthetic_integration u)).e = (synthetic_integration u).e := by
  unfold synthetic_integration
  ring
...
theorem synthetic_integration_automatic_differentiation_layer (u : ProtorealManifold) : (automatic_differentiation (synthetic_integration u)).l = u.l + 1 := by
  unfold synthetic_integration
  unfold automatic_differentiation
  rfl
...
theorem automatic_differentiation_doubles_real (u : ProtorealManifold) : (automatic_differentiation u).a = u.a * 2 := by
  unfold automatic_differentiation
  rfl
...
theorem synthetic_integration_zero_noise_identity (u : ProtorealManifold) (h : u.e = 0) : (synthetic_integration u).a = u.a := by
  unfold synthetic_integration
  simp [h]
...
theorem crystallization_conjunction (u : ProtorealManifold) : (synthetic_integration u).e = 0 ∧ (synthetic_integration u).l = u.l + 1 := by
  unfold synthetic_integration
  simp
